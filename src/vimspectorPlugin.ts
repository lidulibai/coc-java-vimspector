import { commands, Uri, window, workspace, WorkspaceConfiguration, WorkspaceFolder } from 'coc.nvim';
...
export async function startVimspector(
  ...
  if (typeof nameOrConfiguration === 'string') {
    ...
    debugConfig = await resolveAndValidateDebugConfiguration(folder, nameOrConfiguration);
  }
...
async function resolveAndValidateDebugConfiguration(folder: WorkspaceFolder | null, config: DebugConfiguration) {
